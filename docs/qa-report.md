...
| Booking (enlace de búsqueda) | **Verificado por el usuario el 2026-09-23**: mantiene fechas y número de personas (D-007). No documentado oficialmente: puede cambiar sin aviso |
