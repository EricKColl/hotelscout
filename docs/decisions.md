...
**Verificado:** con el estilo Liberty real (descargado de GitHub) y teselas simuladas de Tokio, el mapa rotula «Tokio», «Estación de Tokio», «Ginza», «Marunouchi», «Harumi-dori». **Pendiente:** verlo con las teselas reales en la web publicada (el entorno de desarrollo no tenía acceso a tiles.openfreemap.org). **Estado: pendiente de revisión por el usuario.**
